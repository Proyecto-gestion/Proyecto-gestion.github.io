document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', async (event) => {
    ...
    const { data, error } = await supabase
      .from('innovacion_pedagogica')  // Nombre de la tabla en Supabase
      .insert([{
    ...
    window.location.href = "innovacion-pedagogica.html";  // Redirige a la página de Innovación Tecnológica
  });
});
